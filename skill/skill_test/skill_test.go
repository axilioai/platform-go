...
func TestSkillGetSkillWithWireMock(
	t *testing.T,
) {
	...
	invocationErr := client.Skill.GetSkill(
		context.TODO(),
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestSkillGetSkillWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestSkillGetSkillWithWireMock", "GET", "/skill", nil, 1)
}
