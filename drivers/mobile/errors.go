...
const (
	...
	// CodeConnection — the control WebSocket failed and could not be
	...
	// CodeSessionEnded — the session is over: the server closed with 1000
	...
	// CodeControlHeld — another controller holds the session's control
