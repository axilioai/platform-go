...
func TestUploadsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Uploads.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestUploadsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestUploadsListWithWireMock", "GET", "/uploads", nil, 1)
}
...
func TestUploadsCreateWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestUploadsCreateWithWireMock", "POST", "/uploads", nil, 1)
}

func TestUploadsDeleteWithWireMock(
	t *testing.T,
) {
	WireMockBaseURL := os.Getenv("WIREMOCK_URL")
	if WireMockBaseURL == "" {
	...
	_, invocationErr := client.Uploads.Delete(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestUploadsDeleteWithWireMock"}},
		),
	)
...
func TestUploadsCompleteWithWireMock(
	...
	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestUploadsCompleteWithWireMock", "POST", "/uploads/upload_id/complete", nil, 1)
}
